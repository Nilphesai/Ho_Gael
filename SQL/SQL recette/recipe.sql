...
-- Listage des données de la table recipe.category : ~2 rows (environ)
...
-- Listage des données de la table recipe.ingredient : ~27 rows (environ)
...
-- Listage des données de la table recipe.recipe : ~12 rows (environ)
INSERT INTO `recipe` (`id_recipe`, `recipe_name`, `preparation_time`, `instructions`, `id_category`) VALUES
	...
	(3, 'salade de fruit automne', 5, 'prenez des fruits frais (dans cette recettte, pomme, poire et raisin) les mettre dans un bol et servir', 3),
	...
	(11, 'Pates à la carbonara', 30, 'faites bouillir les pâtes, en parallele cuire les lardons avec de la crème fraiche, mélanger une fois les pâtes cuites, servez', 2),
	(13, 'Eau chaude', 1, 'La recette de la tasse d’eau \r\nchaude qui consiste à verser de l’eau chaude dans une tasse', 1),
	(14, 'Pâtes au lardons', 15, 'Cuires les pates puis cuires les lardons, servez', 2);
...
-- Listage des données de la table recipe.recipe_ingredients : ~37 rows (environ)
